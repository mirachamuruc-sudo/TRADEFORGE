...
import type { CommunitySection } from '../../types.ts';
...
export const CreatePostModal: React.FC<CreatePostModalProps> = ({
  ...
  const [section, setSection] = useState<CommunitySection>('Discussions');
      ...
      <div className="w-full max-w-lg bg-[#0D0D0D] border border-[#242424] rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95">
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#242424]">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-bold text-white">Start a Community Topic</h3>
              <p className="text-xs text-[#999999]">Share knowledge, feedback, questions, or showcases</p>
            </div>
          </div>
        ...
        {!user ? (
          <div className="p-8 text-center">
            ...
            <p className="text-xs text-[#999999] max-w-sm mx-auto mt-1 mb-6">
              Sign in to participate in developer forums, ask questions, or share community feedback.
            </p>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div>
              <label className="block text-xs font-medium text-[#999999] mb-1.5">Topic Title</label>
              <input
                type="text"
                required
                value={title}
                onChange={(e) => setTitle(e.target.value)}
                placeholder="What would you like to discuss with developers?"
            ...
            <div>
              <label className="block text-xs font-medium text-[#999999] mb-1.5">Community Section</label>
              <select
                value={section}
                onChange={(e) => setSection(e.target.value as CommunitySection)}
            ...
            <div>
              <label className="block text-xs font-medium text-[#999999] mb-1.5">Content</label>
              <textarea
                rows={4}
                required
                value={content}
            ...
            <div>
              ...
              <input
                ...
                placeholder="scripting, studio, physics, luau"
            ...
            <div className="flex justify-end gap-2.5 pt-3 border-t border-[#242424]">
              ...
              >
                {isSubmitting ? 'Publishing...' : 'Post Topic'}
              </button>
            </div>
          </form>
        )}
